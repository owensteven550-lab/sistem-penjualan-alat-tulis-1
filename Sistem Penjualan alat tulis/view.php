...
<html lang="en">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <h4 class="mt-4">Kasir : <?php echo $username; ?></h4>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php
                                    $data = mysqli_query($koneksi,"select * from detailpesanan p, produk pr where p.idproduk=pr.idproduk and idpesanan='$idp'");
                                    $i = 1;
                                    ...
                                    ?>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                <input type="text" name="iddetailpesanan" class="form-control mt-2" placeholder="ID Detail Pesanan" value="<?php echo $iddp; ?>" disabled>
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="editdetailpesanan">Ya</button>
                                        ...
                                        <!-- Untuk Menghapus Barang Pesanan -->
                                        <!-- The Modal -->
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <input type="hidden" name="idp" value="<?php echo $iddp; ?>">
                                                <input type="hidden" name="idpr" value="<?php echo $idpr; ?>">
                                                <input type="hidden" name="idorder" value="<?php echo $idp; ?>">
                                                </div>
    ...
    <!-- Untuk Menambahakan Barang Pesanan pada tombol Tambah Barang -->
    <!-- The Modal -->
<div class="modal fade" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body">
      <input type="text" name="iddetailpesanan" class="form-control mb-4" placeholder="ID Detail Pesanan">
      Pilih Barang
